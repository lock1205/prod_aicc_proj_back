...
#     api_key = "46a1518d7f38afc6357a6513cea1368f"
#     web_paths=(f"https://openweathermap.org/data/2.5/weather?q={city}&appid={api_key},),
#     bs_kwargs=dict(
...
# loader = DirectoryLoader("./data", glob="*.txt", loader_cls=UTF8TextLoader)//중복된 문장
...
# recieved_question="일자리 카페  관련된 정책을 알려줘"
